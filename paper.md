...
One critical tool in the linked data (LD) lifecycle is search, browsing and exploration.
...
In contrast to websites, RDF resources are intended to be processed by machines and do not provide a standardized way of being displayed.
...
RickView has the following design goals:

* performance: low memory and CPU utilization, low latency page and high throughput
...
It has already been used in the SNIK [@snik] and HITO [@hito] research projects as a LodView replacement and in LinkedSpending [@linkedspending] as a replacement for Virtuoso SPARQL Endpoint + OntoWiki.
As a case study, LinkedSpending was published in ... and ... server ... memory ... CPU ...
TODO: this is not yet done but needs to be before this paper is submitted

The combination of performance, adaptability and robustness will enable 

## Future Work

## Acknowledgements

We acknowledge LodView.
